...
| [tagentacle-py-core](https://github.com/Tagentacle/tagentacle-py-core) | `pytest` | SDK 单元测试（Python） |
| [tagentacle-py-mcp](https://github.com/Tagentacle/tagentacle-py-mcp) | `pytest` | MCP 桥接单元测试 |
...
1. 上游仓库打新 tag（例如 `tagentacle-py-core` v0.4.0）
